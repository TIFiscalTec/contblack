            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <motion.div style={{ flex: "1 1 300px" }} initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
                        <img src="/assets/sobreNos.jpg" alt="Descrição" style={{ width: "100%", height: "auto", borderRadius: "50%" }} />
                    </motion.div>
                        ...
                        <div style={{
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    onClick={() => window.open(gerarLinkWhatsApp("Olá, gostaria de entender melhor sobre a solução."), '_blank')}
                                >
                            ...
                            >
                                <img
                                    src={solution.img}
                                    alt={solution.title}
                                    style={{ width: "100%", height: "auto", borderRadius: "20px 0 20px 0" }}
                                />
                            </motion.div>
                        </div>
                    </motion.div>
